 ...
 * functions most important of them being to find the path.
...
export default class Car{
    ...
    changefeature(temp){
        ...
        temp.setLineWidth(5,10);
        temp.isFilled = true;
        // temp.setScale(scene.scalefactor);
        // temp.setInteractive();
    }
    ...
    drawpaths(scene){
        ...
        let fs = 1;
        let sc = 1;
        let preX = 20; //scene.dimX/2;
        let preY = 45; //scene.dimY/2;
        let dimX = 72; //scene.dimX;
        let dimY = 58; //scene.dimY;
            ...
            for(let j=0; j<this.paths[i].length-1; j++){
                if(bias > 0){
                    ...
                    if(horizontal){
                        ...
                        prevY = y2;
                        // console.log();
                        console.log("Drawing path from: ",x1,y1,x2,y2);
